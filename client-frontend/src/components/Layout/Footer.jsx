    ...
    <footer className="footer">
      <div className="footer-container">
        <div className="footer-section">
          <h3 className="footer-title">Acces spre Succes</h3>
        ...
        <div className="footer-section">
          <h4 className="footer-heading">{t('nav.projects')}</h4>
          <ul className="footer-links">
            <li>
              <Link to="/upcoming-projects">{t('nav.upcomingProjects')}</Link>
            </li>
            <li>
              <Link to="/completed-projects">{t('nav.completedProjects')}</Link>
            </li>
            <li>
        ...
        <div className="footer-section">
          <h4 className="footer-heading">{t('common.learnMore')}</h4>
          <ul className="footer-links">
            <li>
        ...
        <div className="footer-section">
          ...
          <ul className="footer-contact">
            ...
            <li>
              <a href="tel:+40741963166">+40 741 963 166</a>
            </li>
          </ul>
          <div className="social-links">
            <a
              href="https://www.facebook.com/profile.php?id=61583332327364"
              target="_blank"
            ...
            <a
              href="https://www.instagram.com/acces.spre.succes/"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://www.tiktok.com/@acces.spre.succes"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="TikTok"
            >
            ...
            <a
              href="https://www.linkedin.com/company/acces-spre-succes"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="LinkedIn"
            >
