  ...
  ro: {
    translation: {
      ...
      donate: {
        ...
        impactTitle: "Unde ajunge sprijinul tău",
        impactIntro: "Nu facem promisiuni vagi. Banii donați merg direct în programe concrete pentru copiii din județul Bistrița-Năsăud.",
        impactEducationTitle: "Meditații și rechizite",
        impactEducationText: "Susținem copiii din familii cu posibilități reduse cu meditații gratuite și materialele școlare de care au nevoie pentru a ține pasul cu colegii lor.",
        impactMentoringTitle: "Activități și tabere",
        impactMentoringText: "Organizăm activități extracurriculare, ateliere și tabere educative - experiențe la care mulți dintre ei nu ar ajunge altfel.",
  ...
  en: {
    translation: {
      ...
      donate: {
        ...
        email: "admin@acces-spre-succes.ro",
        impactTitle: "Where your support goes",
        impactIntro: "No vague promises. Every donated leu goes directly into real programs for children across Bistrita-Nasaud county.",
        impactEducationTitle: "Tutoring and school supplies",
        impactEducationText: "We support children from low-income families with free tutoring and the school materials they need to keep up with their peers.",
        impactMentoringTitle: "Activities and camps",
        impactMentoringText: "We run extracurricular activities, workshops and educational camps - experiences many of them simply wouldn't have access to otherwise.",
